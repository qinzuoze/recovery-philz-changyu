...
ifeq ($(LOCAL_PATH),bootable/recovery-philz)
...
ifdef PHILZ_TOUCH_RECOVERY
    ...
    RECOVERY_MOD_NAME := 安热论坛制定刷机恢复系统
else
...
BOARD_RECOVERY_DEFINES := BOARD_RECOVERY_MTK BOARD_HAS_NO_SELECT_BUTTON BOARD_RECOVERY_ALWAYS_WIPES BOARD_RECOVERY_HANDLES_MOUNT TARGET_USE_CUSTOM_LUN_FILE_PATH BOARD_UMS_LUNFILE TARGET_DEVICE TARGET_RECOVERY_FSTAB
...
ifeq ($(BOARD_CUSTOM_RECOVERY_UI),)
  LOCAL_SRC_FILES += default_recovery_ui$(src_suffix).c
else
